    ...
    return function (e) {
        ...
        (function (e) {
            ...
            t.DefaultOptions = {
                ...
                http: {
                    version: 6,
                    api: "https://hummus.sys42.net/api",
                    cdn: "https://hcdn.sys42.net",
                    invite: "https://hummus.sys42.net/invite/"
                }
        ...
        e.exports = class Message extends n {
            ...
            get url() {
                return `https://hummus.sys42.net/channels/${this.guild?this.guild.id:"@me"}/${this.channel.id}/${this.id}`
            }
            get cleanContent() {
